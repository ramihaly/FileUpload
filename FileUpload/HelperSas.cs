...
namespace WebApplication1
{
	public class HelperSas
	{
		public static string GetToken()
		{
			...
			blobPermissions.SharedAccessPolicies.Add("mypolicy-read", new SharedAccessBlobPolicy()
			{
			...
			blobPermissions.SharedAccessPolicies.Add("mypolicy-write", new SharedAccessBlobPolicy()
			{
				// To ensure SAS is valid immediately, don’t set the start time.
				// This way, you can avoid failures caused by small clock differences.
				SharedAccessExpiryTime = DateTime.UtcNow.AddMinutes(15),
			...
			CalculateContainerBytes(container);
		...
		public static void CalculateContainerBytes(CloudBlobContainer container)
		{
